...
VICUNA_PATH = "/model/BJiao/vicuna-13b-v1-5/vicuna-13b-v1.5" #TODO: add path
LLAMA_PATH = "/model/BJiao/CodeLlama-7b-Instruct-hf/CodeLlama-7b-Instruct-hf" #TODO: add path
DEEPSEEK_PATH = "/model/BJiao/deepseek-coder-7b-instru/deepseek-coder-7b-instruct-v1.5" #TODO: add path
CODELLAMA_PATH = "/home/fnii/workspace/codellama-7b" #TODO: add path
QWEN_PATH = "/model/BJiao/Qwen1-5-7B-Chat/Qwen1.5-7B-Chat" #TODO: add path
